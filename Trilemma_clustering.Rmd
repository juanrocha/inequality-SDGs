...
#save(df_dat, file = "data/cleaned_trilemma.RData")
```
...
pc1 <- ggbiplot::ggbiplot(
    ...
    ellipse = TRUE, labels = df_summary$country_code, labels.size = 1,
    varname.size = 1.5) +
...
ggsave(
    ...
    width = 5, height = 4, dpi = 400, bg = "white",
